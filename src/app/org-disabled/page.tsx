  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl border border-slate-200 max-w-md w-full p-8 text-center space-y-4">
        ...
        <h1 className="text-xl font-bold text-slate-900">Access removed</h1>
        <p className="text-sm text-slate-500">
          Your organization&rsquo;s access to the app has been removed. Please contact Coverlog to restore it.
        </p>
