...
select public.ensure_access_log_partition('2027-02-01');
select public.ensure_access_log_partition('2027-03-01');
select public.ensure_access_log_partition('2027-04-01');
select public.ensure_access_log_partition('2027-05-01');
select public.ensure_access_log_partition('2027-06-01');
select public.ensure_access_log_partition('2027-07-01');
select public.ensure_access_log_partition('2027-08-01');
select public.ensure_access_log_partition('2027-09-01');
select public.ensure_access_log_partition('2027-10-01');
select public.ensure_access_log_partition('2027-11-01');
select public.ensure_access_log_partition('2027-12-01');
select public.ensure_access_log_partition('2028-01-01');
select public.ensure_access_log_partition('2028-02-01');
select public.ensure_access_log_partition('2028-03-01');
select public.ensure_access_log_partition('2028-04-01');
select public.ensure_access_log_partition('2028-05-01');
select public.ensure_access_log_partition('2028-06-01');
select public.ensure_access_log_partition('2028-07-01');
select public.ensure_access_log_partition('2028-08-01');
select public.ensure_access_log_partition('2028-09-01');
select public.ensure_access_log_partition('2028-10-01');
select public.ensure_access_log_partition('2028-11-01');
select public.ensure_access_log_partition('2028-12-01');
